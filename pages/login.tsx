        ...
        <div className="container mx-auto px-4 h-full">
          <div className="flex content-center items-center justify-center h-full">
            <div className="w-full lg:w-4/12 px-4 pt-32">
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <form onSubmit={login}>
                    ...
                    <div className="text-center mt-6">
                      {!isVerified && (
                        <button
                          className="border border-gray-900 text-black active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full"
                          type="button"
                          style={{ transition: "all 0.15s ease 0s" }}
              ...
              <div className="flex flex-wrap text-gray-600 mt-6">
                <div className="w-1/2">
                ...
                <div className="w-1/2 text-right">
                  <Link href="/register">
                    <a className="text-sm">Create new account</a>
                  </Link>
                </div>
              </div>
            </div>
